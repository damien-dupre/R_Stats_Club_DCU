...
# create an object gender which combines the word male repeated 50 times and the word female repeated 50 times
education <- c(rep("second",33), rep("undergrad",33), rep("master",34))
# create an object education which combines the word second repeated 33 times, the word undergrad repeated 33 times and the word master repeated 34 times
...
# linear regression (main effects and interaction effect)
